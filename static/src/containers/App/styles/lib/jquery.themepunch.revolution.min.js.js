    ...
    function r(t, n) {
        try {
            if (n.hideThumbsUnderResoluition != 0 && n.navigationType == "thumb") {
                if (n.hideThumbsUnderResoluition > e(window).width())
                    e(".tp-bullets").css({
                        display: "none"
                    });
                else
        ...
        if (n.forceFullWidth == "on")
            i = 0 - n.container.parent().offset().left;
        try {
                ...
                if (!u.hasClass("revslider-initialised")) {
                    ...
                    if (k.length < 9) {
                        if (k.split("slide").length > 1) {
                            ...
                            if (L < 1)
                                L = 1;
                            if (L > u.find(">ul:first >li").length)
                                L = u.find(">ul:first >li").length;
                            o.next = L - 1
                        }
                    }
                    o.origcd = o.delay;
                    ...
                    if (o.lazyLoad == "on") {
                        ...
                        if (M.data("lazyload") != t)
                            M.attr("src", M.data("lazyload"));
                        M.data("lazydone", 1);
                        O = M.parent()
                    }
